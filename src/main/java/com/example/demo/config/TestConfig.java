...
public class TestConfig implements CommandLineRunner {
    /*
    * Para usarmos a boa prática de injeção de dependência, poderíamos setar o UserRepository com um getter/setter,
    * setar no construtor ou usar um Factory.
    * O Spring nos trás esta abstração com a notação @Autowired
    * */
    @Autowired
